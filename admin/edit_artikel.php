...
<body class="bg-merah-light min-h-screen">
    ...
    <div class="flex max-w-7xl mx-auto mt-8 px-4">
        ...
        <aside class="w-1/4 bg-white rounded shadow p-4">
            <h2 class="text-xl font-semibold text-merah-deep mb-4 text-center">MENU</h2>
            <ul class="space-y-2 text-gray-700">
                <li><a href="beranda_admin.php" class="block hover:text-merah-deep">Beranda</a></li>
                <li><a href="data_artikel.php" class="block font-semibold text-merah-deep">Kelola Artikel</a></li>
                <li><a href="data_gallery.php" class="block hover:text-merah-deep">Kelola Gallery</a></li>
                <li><a href="about.php" class="block hover:text-merah-deep">About</a></li>
                <li>
            ...
            <form action="proses_edit_artikel.php" method="post" class="space-y-6">
                ...
                <div>
                    ...
                    <input type="text" id="nama_artikel" name="nama_artikel" required
                        ...
                        class="w-full p-2 border rounded focus:outline-none focus:ring focus:border-merah-deep">
                </div>
                <div>
                    ...
                    <textarea id="isi_artikel" name="isi_artikel" rows="5" required
                        class="w-full p-2 border rounded focus:outline-none focus:ring focus:border-merah-deep"><?php echo htmlspecialchars($data['isi_artikel']); ?></textarea>
                </div>
                <div class="flex justify-end space-x-4">
                    <button type="submit"
                        class="bg-merah text-white px-4 py-2 rounded hover:bg-merah-deep transition">Update</button>
