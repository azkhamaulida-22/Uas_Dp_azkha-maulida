        ...
        <main class="w-3/4 bg-white rounded shadow p-6 ml-6">
            <div class="flex justify-between items-center mb-4">
                ...
                <a href="add_artikel.php"
                    class="bg-merah text-white px-4 py-2 rounded hover:bg-merah-dark transition">+ Tambah Artikel</a>
            </div>
                ...
                <tbody>
                    ...
                    while ($data = mysqli_fetch_array($query)) {
                        ...
                        echo "<td class='border p-2 text-center space-x-2'>
                            <a href='edit_artikel.php?id_artikel={$data['id_artikel']}' class='text-merah-deep hover:underline'>Edit</a>
