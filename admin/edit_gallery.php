    ...
    <div class="flex max-w-7xl mx-auto mt-8 px-4">
        ...
        <aside class="w-1/4 bg-white rounded shadow p-4">
            ...
            <ul class="space-y-2 text-gray-700">
                ...
                <li><a href="data_artikel.php" class="block hover:text-merah-deep">Kelola Artikel</a></li>
                <li><a href="data_gallery.php" class="block font-semibold text-merah-deep">Kelola Gallery</a></li>
                ...
                <div>
                    ...
                    <input type="file" id="foto" name="foto" accept="image/*"
                        class="block w-full text-sm text-gray-600
                               ...
                               file:bg-merah-light file:text-merah-deep
                               hover:file:bg-merah">
                </div>
                <div class="flex justify-end space-x-4">
                    <button type="submit"
                        class="bg-merah text-white px-4 py-2 rounded hover:bg-merah-deep transition">Simpan Perubahan</button>
